...
#EXTRAÇÃO DE DADOS - ESCALONAMENTO EVENTOS&HARDWARE
# Data: 26/27 de novembro de 2024 - Horário: 20:54:12 a 03:02:33
START="2024-11-26T20:54:12Z"
END="2024-11-27T03:02:33Z"
STEP="5s"
...
metricas = [
  ...
  'sum(rate(k6_http_req_duration_p99{method="GET", status="200", url="https://virtualhubs.online"}[1m])) * 1000',

  # 3. Tempo de resposta
  'rate(k6_http_req_waiting_p99{expected_response="true", name="https://virtualhubs.online"}[1m])',
  ...
  '100 * sum(container_memory_usage_bytes{namespace="hcce", pod=~"photomnemonic-.*"}) / sum(node_memory_Active_bytes)',
   ...
   # 61/72 Taxa de transmissão de dados por microsserviços
...
for metrica in metricas:
    ...
    if dados and dados.get("status") == "success":
        ...
        nome_arquivo = f"metrica_{metricas.index(metrica) + 1}.csv"
