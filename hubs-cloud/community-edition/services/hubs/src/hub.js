...
import express = require('express');  // Importando o express


//import client from 'prom-client';  // Importando o prom-client
import express = require('prom-client');  // Importando o express
